...
class _AlbumDetailScreenState extends State<AlbumDetailScreen> {
  ...
  void _openMedia(String url, String fromName, DateTime? createdAt, DocumentReference ref) {
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, i) {
                      ...
                      return GestureDetector(
                        onTap: () => _openMedia(url, fromName, createdAt, rawDocs[i].reference),
                        child: Padding(
